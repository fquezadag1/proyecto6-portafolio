    ...
    <AnimationEffect>
      <main>
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Bienvenido a mi Portafolio!</h1>
          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Aquí encontras informacíon sobre mí y podrás ver los proyectos de desarrollo web FULL STACK que he realizado.</p>
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <Button href="/about" as={Link} size="lg" color="primary" variant="shadow" endContent={<FaArrowRight />}>
              Más sobre Mí
            </Button>
            <Button href="/assets/docs/cv.pdf" as={Link} download={true}  target={'_blank'} size="lg" color="danger" variant="shadow" endContent={<IoMdDownload />}>
              Descarga mi CV
            </Button>
          </div>
          ...
          <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
            ...
            <div className="flex flex-wrap justify-center items-center mt-8 gap-4">
              <a href="https://www.linkedin.com/in/felipe-alejandro-quezada-gonzalez-6741611a5/">
              ...
              <a href='https://github.com/fquezadag1'>
